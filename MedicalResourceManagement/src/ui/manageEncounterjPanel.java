...
public class manageEncounterjPanel extends javax.swing.JPanel {
    ...
    public manageEncounterjPanel( JPanel workarea,PatientDirectory patientHistory,Patient patient, EncounterHistory encounterhistory/*, ArrayList<Encounter> patientencounterhistory*/)
    {
        initComponents();
...
//        txt2.setText(patient.getName());
//        txt3.setText(patient.getCommunityName());
//        txt4.setText(patient.getCity());
////        
...
//        
    ...
    private void initComponents() {
        ...
        EncounterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient Id", "Patient Name", "Community", "City", "Hospital ID", "Doctor ID"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Integer.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.Object.class
            };
...
//            row[10] = encounter.getTemperature();
     ...
     private void PopulateTable1() {
        ...
        for(Patient patient : patientHistory.getPatientHistory())
        {
...
//            if(patient.getPatientId() == Integer.parseInt(txt1.getText()))
//            {
                model.addRow(row);
//            }
        }
