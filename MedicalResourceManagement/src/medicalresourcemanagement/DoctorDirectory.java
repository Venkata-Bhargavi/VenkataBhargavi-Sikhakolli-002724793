...
public class DoctorDirectory {
    ...
    HashMap<String, String> docCredentialsMap; 
...
//        this.credentialsMap = new HashMap();
        ...
        this.docCredentialsMap = new HashMap();
    }
    
    public HashMap<String, String> getDoctorCredentails(){
        docCredentialsMap.put("", "");
        for(Doctor doc: doctorlist){
            docCredentialsMap.put(doc.getUsername(), doc.getPassword());
        }
        return docCredentialsMap;
    }
...
//    Method to search doctor by id
    ...
    public void SearchhosName(String hosname) 
    {
        for(Doctor doctor : doctorlist)
        {
           if(hosname == doctor.getHospitalname())
           {               
               newdoctorlist.add(doctor);
           }
        }
