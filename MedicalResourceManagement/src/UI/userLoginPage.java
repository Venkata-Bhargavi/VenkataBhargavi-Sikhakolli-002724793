...
public class userLoginPage extends javax.swing.JFrame {
    ...
    HashMap<String, String> patientCred;
    HashMap<String, String> doctorCred;
    ...
    public userLoginPage() {
        ...
        this.patientCred = new HashMap<>();
        this.doctorCred = new HashMap<>();
        
//        this.patientCred.put("","");
//        this.doctorCred.put("","");
    }
    ...
    private void initComponents() {
        ...
        titlebox.setText("Medical Resource Management!");
...
//            JOptionPane.showMessageDialog(this, "USER Credentials are correct!");
        ...
        else if(role.equals("Hospital Admin") && (!txt_username.getText().equals(""))  && (!pass_password.getText().equals(""))){
            this.setVisible(false);
            HospitalAdmin ha = new HospitalAdmin(patientlist, doctorlist, encounterhistory, citylist, communitylist);
            ha.setVisible(true);    
        }
        else if(role.equals("Doctor") && pass_password.getText().equals(doctorCred.get(txt_username.getText()))){
            this.setVisible(false);
            DoctorAdmin da = new DoctorAdmin(patientlist, doctorlist, encounterhistory, citylist, communitylist);
            da.setVisible(true);    
        }
        else if(role.equals("Patient") &&  pass_password.getText().equals(patientCred.get(txt_username.getText())) ){
//            (txt_username.getText().equals(""))  && (pass_password.getText().equals(""))
            this.setVisible(false);
            PatientAdmin pa = new PatientAdmin(patientlist, doctorlist, encounterhistory, citylist, communitylist, txt_username.getText());
            pa.setVisible(true);    
        }
        else{
