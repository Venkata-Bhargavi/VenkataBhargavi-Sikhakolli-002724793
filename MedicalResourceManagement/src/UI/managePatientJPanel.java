...
public class managePatientJPanel extends javax.swing.JPanel {
     ...
     */
    public managePatientJPanel(JPanel workArea, PatientDirectory patientlist, EncounterHistory encounterhistory, CommunityDirectory communitylist, CityDirectory citylist, DoctorDirectory doctorlist) {
        initComponents();
    ...
    public void populatehouses(Community c) {
        
        DefaultComboBoxModel model = new DefaultComboBoxModel();

        for(House com: c.getHouselist()) {
    ...
    public void populatehousesinManage(Community c) {
    ...
    private void populateDataToTable() {
        ...
        for (Patient doctor : patientlist.getPatientlist()){
            ...
            row[5] = doctor.getCommunity();
            row[6] = doctor.getCity();
    ...
    private void initComponents() {
        ...
        ddha = new javax.swing.JComboBox<>();
        ...
        txt_ha = new javax.swing.JComboBox<>();

        jTab_manage.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jtab_add.setBackground(new java.awt.Color(204, 204, 255));
        ...
        jtab_add.add(lblHA, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 400, -1, -1));

        lblHAval.setFont(new java.awt.Font("Segoe UI Black", 3, 14)); // NOI18N
        lblHAval.setForeground(new java.awt.Color(255, 51, 51));
        lblHAval.setText(" ");
        jtab_add.add(lblHAval, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 400, 438, 30));

        lblcomm.setText("Community:");
        jtab_add.add(lblcomm, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 350, 110, 30));

        lblcommval.setFont(new java.awt.Font("Segoe UI Black", 3, 14)); // NOI18N
        lblcommval.setForeground(new java.awt.Color(255, 51, 51));
        lblcommval.setText(" ");
        jtab_add.add(lblcommval, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 350, 410, 30));

        lblCity.setText("City:");
        jtab_add.add(lblCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 310, 88, 31));

        lblcityval.setFont(new java.awt.Font("Segoe UI Black", 3, 14)); // NOI18N
        lblcityval.setForeground(new java.awt.Color(255, 51, 51));
        lblcityval.setText(" ");
        jtab_add.add(lblcityval, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 310, 430, 30));
        ...
        jtab_add.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 560, 110, -1));
        ...
        ddcom.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                ddcomKeyReleased(evt);
            }
        });
        jtab_add.add(ddcom, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 350, 230, -1));

        ddha.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ddhaActionPerformed(evt);
            }
        });
        ddha.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                ddhaKeyReleased(evt);
            }
        });
        jtab_add.add(ddha, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 400, 230, -1));
        ...
        ddcity.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                ddcityKeyReleased(evt);
            }
        });
        jtab_add.add(ddcity, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 310, 230, -1));
...
//        Checking the username exists in the patientdirectory.
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String houseaddress = ddha.getSelectedItem().toString();
        ...
        if(lblnameval.getText() != "" || ddcity.getSelectedIndex() == -1 || ddcom.getSelectedIndex() == -1 || ddha.getSelectedIndex() == -1 || lblunval.getText() != "" || lblpwdval.getText() != ""){
            ...
            txtage.setText("");
            ddha.setSelectedIndex(-1);
            ddcom.setSelectedIndex(-1);
            txtun.setText("");
            txtpwd.setText("");
            
            populatecity();
        
            ddcity.setSelectedIndex(-1);
        }
    ...
    private void btnEncounterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEncounterActionPerformed
        ...
        Patient patient = patientlist.searchPatientId(patient_id);
...
//        manageEncounterjPanel encounterPanel = new manageEncounterjPanel(WorkArea, patient, encounterhistory, patientencounterhistory, communitylist, doctorlist);
...
//        
    ...
    private void btn_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SaveActionPerformed
        ...
        if(txt_name.getText().isEmpty() || txt_age.getText().isEmpty() || txt_ha.getSelectedIndex() == -1 || txt_un.getText().isEmpty() || txt_pwd.getText().isEmpty()){
            ...
            selectedEntry.setHouseAddress((txt_ha.getSelectedItem().toString()));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        patientlist.deletePatient(selectedEntry);
...
//            return;
        ...
        Community selectedComm = communitylist.searchCommunity(selectedEntry.getCommunity());
        populatehousesinManage(selectedComm);
    ...
    private void ddcomKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ddcomKeyReleased
        // TODO add your handling code here:
        if(ddcom.getSelectedItem().equals(null)){
            lblcommval.setText("Please select a community");
        }
        else{
            lblcommval.setText("");
        }
    }//GEN-LAST:event_ddcomKeyReleased

    private void ddhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ddhaActionPerformed
        // TODO add your handling code here:
        if(ddha.getSelectedIndex() == -1){
            lblHAval.setText("Select a house address");
        }
        else{
            lblHAval.setText("");
        }
    }//GEN-LAST:event_ddhaActionPerformed

    private void ddhaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ddhaKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_ddhaKeyReleased

    private void ddcityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ddcityActionPerformed
        // TODO add your handling code here:
        
        
        if(ddcity.getSelectedIndex() != (-1)){
            lblcityval.setText("");            
        }
        else{
        ...
        String citytxt = (String) ddcity.getSelectedItem();
        
        
        City selectedCity = citylist.searchCity(citytxt);

        
        if(citytxt != null){
            populatecommunities(selectedCity);
        }
        else{
            lblcityval.setText("Select a City.");
        }
    ...
    private void ddcityKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ddcityKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_ddcityKeyReleased
    ...
    private javax.swing.JComboBox<String> ddha;
    ...
    private javax.swing.JComboBox<String> txt_ha;
