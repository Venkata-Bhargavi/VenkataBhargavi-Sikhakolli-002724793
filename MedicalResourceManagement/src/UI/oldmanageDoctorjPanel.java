...
public class oldmanageDoctorjPanel extends javax.swing.JPanel {
    ...
    public oldmanageDoctorjPanel(CityDirectory citylist, CommunityDirectory communitylist, DoctorDirectory doctorlist) {
        ...
        this.newdoctorlist = new DoctorDirectory();
    ...
    private void initComponents() {
        ...
        txthn = new javax.swing.JComboBox<>();
        ...
        jPanel2.add(txthn, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 510, 220, -1));
    ...
    public void populatehospitalsinManage(Community c) {
...
//            return;
        ...
        txt_name.setText(selectedEntry.getDoctorName());
        txt_un.setText(selectedEntry.getUsername());
        txt_pwd.setText(selectedEntry.getPassword());
       
        Community selectedComm = communitylist.searchCommunity(selectedEntry.getCommunity());
        populatehospitalsinManage(selectedComm);
...
//            btn_Save.setEnabled(false);
        ...
        if(txt_name.getText().isEmpty() || txt_un.getText().isEmpty() || txt_pwd.getText().isEmpty() || txthn.getSelectedIndex() == -1){
            ...
            selectedEntry.setDoctorName(txt_name.getText());
            selectedEntry.setHospitalname(txthn.getSelectedItem().toString());
...
//        String password = txtpassword1.getText();
        ...
        if(lblnameval.getText() != "" || ddhn.getSelectedIndex() == -1 || ddcity.getSelectedIndex() == -1 || ddcity.getSelectedIndex() == -1 || lblunval.getText() != "" || lblpwdval.getText() != ""){
...
//            String regex = String.format("^%s$", search);
    ...
    private javax.swing.JComboBox<String> txthn;
